...
# Execution:
# python training-crossvalidation-testing-dom.py --inputPath C:\Users\Jocksan\Google Drive\TercerSemestre\Bioinformatica\MachineLearning\Datasets\LCG-Mendez\clasificacion-automatica\structural-domain-dataset --inputTrainingData trainData.txt --inputTrainingClasses trainClasses.txt --inputTestingData testData.txt --inputTestingClasses testClasses.txt --outputModelPath C:\Users\Jocksan\Google Drive\TercerSemestre\Bioinformatica\MachineLearning\Datasets\LCG-Mendez\clasificacion-automatica\structural-domain-dataset\models --outputModelFile SVM-lineal-model.mod --outputReportPath C:\Users\Jocksan\Google Drive\TercerSemestre\Bioinformatica\MachineLearning\Datasets\LCG-Mendez\clasificacion-automatica\structural-domain-dataset/reports --outputReportFile SVM-linear.txt --classifier SVM --kernel linear --saveData --vectorizer b --ngrinitial 2 --ngrfinal 2 --removeStopWords
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Training validation RI - OTHER sentences dataset.')
